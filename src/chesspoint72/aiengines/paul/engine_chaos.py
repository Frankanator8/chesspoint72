"""engine_chaos.py — Paul's Chaos engine.
...
the score rarely changes drastically between depths — the search opens with a
...
class ChaosSearch(NegamaxSearch):
    ...
    score. For depth 2+, the root opens with a ±50cp window around the

...
from chesspoint72.aiengines.jonathan.v2.agent import (
    AgentContext,
    EngineConfig,
    build_context,
    select_modules,
...
from chesspoint72.aiengines.jonathan.v2.policies import (
...
class CalixController(UciController):
    ...
    engine_name = "Calix v2 (Local scoring selector)"

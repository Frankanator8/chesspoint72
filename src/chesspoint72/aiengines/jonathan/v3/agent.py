"""Module Selector Agent for Calix v3 — driven by Claude Sonnet 4.6.
...
# Calix v3 is pinned to Claude Sonnet 4.6 — the most capable model for
# multi-constraint selection over the module registry.
CALIX_MODEL: str = "claude-sonnet-4-6"
